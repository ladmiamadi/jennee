...
import NewMemberForm from '../../../common/form/NewMemberForm'
...
const NewMemberComponent = ({ setFormValue, formValue, HandleSubmit, handleChange, error, setError, errortype, setErrortype }) => {
    return (
        <>
            <Grid className="page">
